...
## Introduction
<font size="3"> In this exercise, we want to compare the margherita pizza price and beverage price from pizza restaurants in inner and outer Budapest. Data in this set were collected from different online sources, such as restaurant website and [Netpincer](www.netpincer.hu). There are 44 observations from inner and outer Budapest pizza restaurants on their 32cm Margherita Pizza and 0.5l beverage price. 
</font> 
